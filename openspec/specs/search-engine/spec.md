...
The search engine system SHALL compile parsed query ASTs into optimized SQL queries and execute searches against the cards database, supporting field-specific operators, boolean logic, sorting, and result filtering.
## Requirements
