...
The query parser system SHALL tokenize and parse natural language query strings into an Abstract Syntax Tree (AST), supporting a rich set of field operators, keywords, and precedence rules for Magic: The Gathering card search.
## Requirements
